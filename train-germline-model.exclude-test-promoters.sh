...
work_directory="work-train-germline-model.exclude-test-promoters.windowSize-${window_size}"
...
neutral_regions="${CONSTRAINT_TOOLS}/dist/neutral-regions-germline-grch38-exclude-test-promoters.bed.gz"
...
fetch_subset_of_neutral_regions () { 
  less ${neutral_regions} | head -10000
}
