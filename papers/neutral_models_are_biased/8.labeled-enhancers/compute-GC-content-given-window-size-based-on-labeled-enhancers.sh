...
LABELED_ENHANCERS_DATA_DIRECTORY="${CONSTRAINT_TOOLS_DATA}/labeled-enhancers"
LABELED_ENHANCERS_FILE_STEM="labeled-enhancers" 

WINDOW_SIZE="${1}" 

source "${CONSTRAINT_TOOLS}/papers/neutral_models_are_biased/8.labeled-enhancers/get-windows-from-labeled-enhancers.sh"
...
write-to-disk () {
  local filename="${LABELED_ENHANCERS_DATA_DIRECTORY}/${LABELED_ENHANCERS_FILE_STEM}.GC_content_${WINDOW_SIZE}.bed"
