...
training_durations_filename="tests/germline-model/train-durations.${number_of_jobs}-jobs.Nonly.tsv"
...
for number_of_trustworthy_noncoding_regions in $number_of_trustworthy_noncoding_regions_list; do
  ...
  time_output_file="tests/germline-model/${number_of_trustworthy_noncoding_regions}.Nonly.time"
  /usr/bin/time --verbose --output "${time_output_file}" bash tests/germline-model/train-germline-model-Nonly-core.sh \
    ...
    --work-directory "work-train-germline-model-Nonly-${number_of_trustworthy_noncoding_regions}" \
