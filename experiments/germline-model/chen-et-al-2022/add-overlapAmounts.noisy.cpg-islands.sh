...
chen_mchale_windows="${CONSTRAINT_TOOLS_DATA}/benchmark-genome-wide-predictions/chen-et-al-2022/mchale.kmerSizes.trainSets.noisy.bed"
...
# download-process-data/download-cpg-islands-grch38.sh
cpg_islands="${CONSTRAINT_TOOLS_DATA}/cpg-islands/grch38/cpg-islands.sorted.bed.gz"
...
# get-cpg-islands | head 

header-line () {
  set +o errexit
  echo -e "$(head -1 ${chen_mchale_windows})\tfeature\tfeature_chromosome\tfeature_start\tfeature_end\twindow_feature_overlap_bps"
  set -o errexit
}
...
chen_mchale_windows_with_overlapAmounts="${CONSTRAINT_TOOLS_DATA}/benchmark-genome-wide-predictions/chen-et-al-2022/mchale.kmerSizes.trainSets.noisy.overlapAmounts.cpg-islands.bed"
(
  header-line
  add-overlapAmounts
