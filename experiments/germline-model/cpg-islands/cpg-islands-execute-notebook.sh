...
input_notebook="${CONSTRAINT_TOOLS}/experiments/germline-model/cpg-islands/cpg-islands-compute-zscores.ipynb"

number_neutral_bases="$1"

output_notebook="${CONSTRAINT_TOOLS}/experiments/germline-model/cpg-islands/"\
"cpg-islands-compute-zscores.${number_neutral_bases}.ipynb"
